...
def get_args():
    ...
    parser.add_argument('--wandb_project', type=str, default='Transliteration', help='Project Name')
    ...
    parser.add_argument('--input_embedding', type=int, default=128, help='Input embedding size')
    ...
    parser.add_argument('--cell_type',type=str,default='LSTM',help='Type of RNN cell to use (LSTM, GRU, etc.)')
    parser.add_argument('--dropout',type=float,default=0.3,help='Dropout probability in dense layers')
